...
$(function() {
	...
	//返回列表页
	function backList() {
		window.location.href = '${pageContext.request.contextPath}/whitenames/toGetNameList.do?nameType=01';
	}
	
	//保存信息
	function saveObj() {
		var url='${pageContext.request.contextPath}/whitenames/modifyName.do';
			...
			<table class="modifytable" width="100%">
				...
				<tr>
					<td colspan="4" align="center"><input type="button" value="保存"
						...
						type="hidden" name="nameType" value="01" /> <input type="hidden"
