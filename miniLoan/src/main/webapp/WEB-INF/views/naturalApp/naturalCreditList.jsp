...
<title>natural credit list</title>
<script type="text/javascript">

	$(function() {
		$('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/natural/app/creditAppList.do?NaturalappNo=${appNo}',
			fit : true,
			fitColumns : true,
			striped : true,
			border : false,
			...
			columns : [ [ {
				...
				field : 'newCcIn3mth',
				title : '最近3个月内新开信用卡账户数',
				width : 15,
				sortable : true
			}, {
				field : 'lastActiveCcCount',
				title : '最近一期活跃信用卡账户数',
				sortable : true,
				width : 20
			} ] ],
	...
	function addNew() {
		window.location.href = '${pageContext.request.contextPath}/natural/credit/toAddNaturalCredit.do';
			...
			<div id="toolbar"
				...
				<table cellspacing="0" cellpadding="0">
					<tr>
						...
						<td><a href="#" class="easyui-linkbutton"
							data-options="iconCls:'icon-ui-sum',plain:true"
							onClick="javascript:editCredit();" style="float: left;">征信记录维护</a></td>
						<td>
							<div class="datagrid-btn-separator"></div>
						</td>
						<td><a href="#" class="easyui-linkbutton"
							data-options="iconCls:'icon-ui-sum',plain:true"
							onClick="javascript:editAttach();" style="float: left;">附件维护</a></td>
						<td>
							<div class="datagrid-btn-separator"></div>
						</td>
						<td><a href="#" class="easyui-linkbutton"
							data-options="iconCls:'icon-ui-sum',plain:true"
							onClick="javascript:editMortgate();" style="float: left;">抵押物维护</a></td>
					</tr>
				</table>
			</div>
		</div>
