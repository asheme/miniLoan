...
<!--
	$(function() {
		initComboboxContent("hasCreditInfo", "YES_OR_NO");
	});
	...
	function reloadPage() {
		...
		window.location.href = "${pageContext.request.contextPath}/natural/credit/toModifyNaturalCredit.do?appNo="
				+ appNo;
	}
			...
			<table class="modifytable" width="100%">
				<tr>
					...
					<td width="25%"><input class="easyui-validatebox"
						name="hasCreditInfo" value="${naturalCredit.hasCreditInfo}"
				...
				<tr>
					...
					<td width="25%"><input class="easyui-validatebox"
						name="pastDueTimes" value="${naturalCredit.pastDueTimes}"
						data-options="required:false,validType:'length[0,30]'"
						style="width: 250px;" id="pastDueTimes" /></td>
					<th align="center" width="25%">最高逾期数</th>
					<td width="25%"><input class="easyui-validatebox"
						name="highestDelinquencyCycle"
						value="${naturalCredit.highestDelinquencyCycle}"
						data-options="required:false,validType:'length[0,30]'"
						style="width: 250px;" id="highestDelinquencyCycle" /></td>
				</tr>
				<tr>
					<th align="center" width="25%">逾期信用余额</th>
					<td width="25%"><input class="easyui-validatebox"
						name="amountOfDelinquency" value="${naturalCredit.amountOfDelinquency}"
						data-options="required:false,validType:'length[0,30]'"
						style="width: 250px;" id="amountOfDelinquency" /></td>
				...
				<tr>
					<td colspan="4" align="center"><input type="button" value="保存"
						...
						value="清空" class="btn" onclick="clearNaturalCredit();" /> <input
						type="hidden" name="appNo" value="${naturalCredit.appNo}" /> <input
