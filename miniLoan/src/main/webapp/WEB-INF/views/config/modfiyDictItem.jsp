		...
		<form id=modifyForm method="post">
			<table id="update" class="modifytable" width="100%">
				...
				<tr>
					...
					<td><input name="seq" value="${item.seq}" id="itemSeq"
						validType="seqChk" style="width: 100px" class="easyui-validatebox" /></td>
				</tr>
				<tr>
					<th align="center" width="35%">状态</th>
					<td><input name="status" value="${item.status}" id="status"
