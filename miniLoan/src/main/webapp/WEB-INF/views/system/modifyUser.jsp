		...
		<form id="modifyForm" method="post">
			<table id="update" class="modifytable" width="100%">
				<tr>
					...
					<td><input id="loginId" class="easyui-validatebox"
						name="loginId" validType="length[1,10]"
						data-options="required:true" value="${userObj.loginId}"
				...
				<tr>
					<td colspan="2" align="center"><input type="button" value="保存"
						...
						type="hidden" name="userId" value="${userObj.userId}" /> <input
