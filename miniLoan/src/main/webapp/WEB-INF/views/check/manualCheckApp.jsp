...
<title>manual application check</title>
<script type="text/javascript">
<!--
	$(function(){
		initComboboxContent("status", "MANUAL_CHECK_STATUS");
	});
	...
	function submitToApprove() {
		...
		$('#submitForm')
				.form(
						'submit',
						{
							url : '${pageContext.request.contextPath}/manualcheck/app/submitToApprove.do',
					...
					<table class="modifytable" width="100%" height="100%">
						...
						<tr>
							<td colspan="2" align="center"><input type="button"
								value="提交" class="btn" onclick="submitToApprove();" /> <input
