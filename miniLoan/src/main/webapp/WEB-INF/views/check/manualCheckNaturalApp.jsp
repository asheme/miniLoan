...
<script type="text/javascript">
	...
	$(function() {
		...
		document.getElementById("mortgageIframe").src = '${pageContext.request.contextPath}/natural/mortgage/showMortgageList.do?appNo='
				+ appNo;
		document.getElementById("crossCheckIframe").src = '${pageContext.request.contextPath}/manualcheck/app/toCrossCheckResult.do?appNo='
			+ appNo;
	...
	function backList() {
		window.location.href = '${pageContext.request.contextPath}/menu/manualCheckList.do';
	}
	...
	function submitToNext() {
		$('#submitForm')
				.form(
						'submit',
						{
							url : '${pageContext.request.contextPath}/manualcheck/app/goToNext.do?appNo=${appNo}',
	...
	<div class="easyui-layout" data-options="fit : true,border : false">
		<div data-options="region:'center',border : false">
			<div id="tabs" class="easyui-tabs"
				...
				<div title="交叉检查结果">
					<iframe id="crossCheckIframe" width="100%" height="100%"
						frameborder="no" border="0"></iframe>
				</div>
				<div title="审核记录">
