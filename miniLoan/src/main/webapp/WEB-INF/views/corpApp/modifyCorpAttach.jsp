...
<title>create or modify corp attach</title>
<script type="text/javascript">
	//返回列表页
	function backList() {
		window.location.href = '${pageContext.request.contextPath}/corp/attach/toCorpAttachList.do?appNo=${corpAttach.appNo}';
	}

	//保存信息
	function saveObj() {
		var url='${pageContext.request.contextPath}/corp/attach/modifyCorpAttach.do';
			...
			<table class="modifytable" width="100%">
				<tr>
					...
					<td width="70%"><input class="easyui-validatebox"
						name="fileDesc" value="${corpAttach.fileDesc}"
				...
				<tr>
					<td colspan="2" align="center"><input type="button" value="保存"
						...
						type="hidden" name="appNo" value="${corpAttach.appNo}" /> <input
						type="hidden" name="fileNo" value="${corpAttach.fileNo}" /> <input
