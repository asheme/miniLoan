...
<script type="text/javascript">
	...
	function addNew() {
		window.location.href = '${pageContext.request.contextPath}/corp/attach/toAddCorpAttach.do?appNo=${appNo}';
		...
		if (rows.length > 0) {
			$.messager.confirm('信息提示', '您确认要删除当前选中的记录？', function(r) {
				if (r) {
					...
					$.ajax({
						url : '${pageContext.request.contextPath}/corp/attach/deleteCorpAttach.do',
						data : {
							ids : ids.join(',')
						},
						type : "POST",
