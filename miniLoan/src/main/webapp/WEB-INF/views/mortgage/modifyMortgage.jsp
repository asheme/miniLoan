...
<title>create or modify mortgate</title>
<script type="text/javascript">
	...
	//返回列表页
	function backList() {
		window.location.href = '${pageContext.request.contextPath}/mortgage/toMortgageList.do?appNo=${mortgageInfo.appNo}';
	}
	
	//保存信息
	function saveObj() {
		var url='${pageContext.request.contextPath}/mortgage/modifyMortgageInfo.do';
		...
		<form id="modifyForm" method="post">
			<table class="modifytable" width="100%">
				...
				<tr>
					...
					<td width="25%"><input class="easyui-validatebox"
						name="mortgagorIdNo" value="${mortgageInfo.mortgagorIdNo}"
						data-options="required:false,validType:'length[0,30]'"
						style="width: 250px;" id="mortgagorIdNo" /></td>
					<th align="center" width="25%">抵押人联系电话</th>
					<td width="25%"><input class="easyui-validatebox"
						name="mortgagorPhone" value="${mortgageInfo.mortgagorPhone}"
						data-options="required:false,validType:'length[0,30]'"
				...
				<tr>
					...
					<td width="25%"><input class="easyui-validatebox"
						name="legalPerson" value="${mortgageInfo.legalPerson}"
						data-options="required:false,validType:'length[0,30]'"
						style="width: 250px;" id="legalPerson" /></td>
					<th align="center" width="25%">地址</th>
					<td width="25%"><input class="easyui-validatebox"
						name="mortgageAddr" value="${mortgageInfo.mortgageAddr}"
						data-options="required:false,validType:'length[0,30]'"
				...
				<tr>
					...
					<td width="25%"><input class="easyui-validatebox"
						name="mortgageName" value="${mortgageInfo.mortgageName}"
						data-options="required:false,validType:'length[0,30]'"
						style="width: 250px;" id="mortgageName" /></td>
					<th align="center" width="25%">产权证编号</th>
					<td width="25%"><input class="easyui-validatebox"
						name="certificationNo" value="${mortgageInfo.certificationNo}"
						data-options="required:false,validType:'length[0,30]'"
				...
				<tr>
					...
					<td width="25%"><input class="easyui-validatebox"
						...
						value="${mortgageInfo.mortgageLocation}"
						data-options="required:false,validType:'length[0,30]'"
						style="width: 250px;" id="mortgageLocation" /></td>
					<th align="center" width="25%">面积、数量</th>
					<td width="25%"><input class="easyui-validatebox"
						name="mortgageArea" value="${mortgageInfo.mortgageArea}"
						data-options="required:false,validType:'length[0,30]'"
				...
				<tr>
					...
					<td width="25%"><input class="easyui-validatebox"
						...
						value="${mortgageInfo.buyDate}"
						data-options="required:false,validType:'length[0,30]'"
						style="width: 250px;" id="buyDate" /></td>
					<th align="center" width="25%">原值</th>
					<td width="25%"><input class="easyui-validatebox"
						name="oldValue" value="${mortgageInfo.oldValue}"
						data-options="required:false,validType:'length[0,30]'"
				...
				<tr>
					...
					<td width="25%"><input class="easyui-validatebox"
						name="status" value="${mortgageInfo.status}"
						data-options="required:false,validType:'length[0,30]'"
