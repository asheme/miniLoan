...
@Controller
@RequestMapping(value = "/whitenames")
public class WhiteNameListController extends BaseController {
	...
	public ModelAndView toGetNameList(String nameType) {
		...
		modelAndView.setViewName("nameList/whiteNameList");
	...
	public ModelAndView toAddName() {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("nameList/modifyWhiteName");
